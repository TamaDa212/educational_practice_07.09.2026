...
class PartnerEditWindow:
    ...
    def combo_options(self):
        ...
        # Тип с карточки оставляем в списке, даже если его нет в справочнике ТЗ.
    ...
    def render_form(self):
        values = self.values
        # ID партнёра передаётся между окнами скрытым полем: POST знает, кого сохранять.
